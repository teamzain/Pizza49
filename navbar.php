...
<body>
    <nav class="sidebar">
        ...
        <?php if (in_array("products_data.php", $sections_to_display) || in_array("purchase.php", $sections_to_display) || in_array("sale.php", $sections_to_display) || in_array("return_exchange_page.php", $sections_to_display) || in_array("return_exchange_page.php", $sections_to_display)): ?>
            <div class="menu-section">
 ...
 <?php if (in_array("daily_report.php", $sections_to_display) || in_array("monthly_report.php", $sections_to_display) || in_array("yearly_report.php", $sections_to_display)): ?>
            <div class="menu-section">
